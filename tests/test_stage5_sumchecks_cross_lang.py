...
class Stage5SumchecksCrossLangTests(unittest.TestCase):  # Python↔Rust parity: Stage1 → Stage2 → Stage3 → Stage4 → Stage5.
    def test_stage5_sumchecks_match_rust_oracle(self):
        kv = _parse_kv_lines(run_rust_oracle("stage5_sumchecks_blake2b", "").strip())
        ...
        oracle_r = _csv_fr(kv["stage5_r_sumcheck"])
        self.assertEqual(r_sumcheck_stage5, oracle_r)
